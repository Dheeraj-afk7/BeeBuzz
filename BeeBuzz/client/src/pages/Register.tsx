        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-row">
            <div className="form-group" style={{ position: 'relative' }}>
              ...
              {formData.password && (
                <div className="password-rules" style={{ fontSize: '12px', marginTop: '8px', padding: '8px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px' }}>
                  <div style={{ color: passwordRules.length ? '#10B981' : '#ef4444' }}>{passwordRules.length ? '✓' : '✗'} Min 8 characters</div>
                  <div style={{ color: passwordRules.upper ? '#10B981' : '#ef4444' }}>{passwordRules.upper ? '✓' : '✗'} 1 Uppercase letter</div>
                  <div style={{ color: passwordRules.lower ? '#10B981' : '#ef4444' }}>{passwordRules.lower ? '✓' : '✗'} 1 Lowercase letter</div>
                  <div style={{ color: passwordRules.special ? '#10B981' : '#ef4444' }}>{passwordRules.special ? '✓' : '✗'} 1 Special character</div>
                </div>
              )}
            </div>
            <div className="form-group">
