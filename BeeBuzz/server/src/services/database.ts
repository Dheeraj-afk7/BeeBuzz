...
async function initializeTables() {
  ...
  const migrations = [
    ...
    `ALTER TABLE users ADD COLUMN dl_verified INTEGER DEFAULT 0`,
    `ALTER TABLE users ADD COLUMN verification_report TEXT`
  ];
...
function convertSqlToPg(sql: string) {
  let paramIndex = 1;
